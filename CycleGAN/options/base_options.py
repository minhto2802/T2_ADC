...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='T2_ADC_run24', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--dataroot', default='./datasets/maps', required=False, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--which_model_netG', type=str, default='resnet_9blocks', help='selects model to use for netG, unet_256(128) or resnet_9blocks')
        ...
        parser.add_argument('--crop_size', type=int, default=400, help='size of pre-cropped inputs')
        parser.add_argument('--input_size', type=int, default=240, help='size of cropped inputs')
        parser.add_argument('--train_prostateX_only', type=bool, default=False)
