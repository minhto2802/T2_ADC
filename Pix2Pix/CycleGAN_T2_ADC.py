...
if __name__ == "__main__":
    ...
    # Loss
    DX_loss = gluon.loss.SigmoidBinaryCrossEntropyLoss()
    DY_loss = gluon.loss.SigmoidBinaryCrossEntropyLoss()
    GX_loss_L1 = gluon.loss.L1Loss()
    GY_loss_L1 = gluon.loss.L1Loss()

    GX_loss_L2 = gluon.loss.L2Loss()
    GY_loss_L2 = gluon.loss.L2Loss()
    cyc_loss_L2_coef = 10

    SmoothL1_loss = SmoothL1Loss()

    netGY, netGX, netDY, netDX, trainerGY, trainerGX, trainerDY, trainerDX = set_network(ctx, lr, beta1, optimizer=optimizer)
